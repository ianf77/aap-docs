...
The *Automation Templates* page displays cards showing both job templates and workflow job templates that are currently available. 
...
Workflow templates can have the workflow visualizer image:visualizer.png[Workflow visualizer,15,15] icon as a shortcut for accessing the workflow editor.
